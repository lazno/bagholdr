...
import { portfolioRules, portfolios } from '$lib/server/db/schema';
import type { AssetType, ConcentrationLimitConfig } from '$lib/server/db/schema';
...
export const rulesRouter = router({
	...
	createConcentrationLimit: publicProcedure
		...
		.mutation(async ({ ctx, input }) => {
			...
			const ruleId = nanoid();
			const config: ConcentrationLimitConfig = {
