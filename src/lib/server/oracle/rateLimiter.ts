 ...
 * - Enforcing a minimum delay between requests (default 3 seconds)
 * - Queuing requests and processing them sequentially
 * - Being a singleton so ALL Yahoo requests go through it
 *
 * With 3 second delay: 20 requests/min = 1200/hour (safe margin)
 */

import { YAHOO_MIN_REQUEST_DELAY_MS } from '$lib/server/config';
