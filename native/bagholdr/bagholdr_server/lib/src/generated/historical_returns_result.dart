...
import 'package:bagholdr_server/src/generated/protocol.dart' as _i4;

/// HistoricalReturnsResult - Historical returns response
abstract class HistoricalReturnsResult
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'HistoricalReturnsResult',
      'currentValue': currentValue,
      'returns': returns.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'assetReturns': assetReturns.toJson(
        valueToJson: (v) => v.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      ),
    };
  }
