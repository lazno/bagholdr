...
import 'sleeve_tree_response.dart' as _i43;
import 'stale_price_asset.dart' as _i44;
import 'sync_status.dart' as _i45;
import 'ticker_metadata.dart' as _i46;
import 'yahoo_symbol.dart' as _i47;
import 'package:bagholdr_server/src/generated/portfolio.dart' as _i48;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i43.SleeveTreeResponse) {
      return _i43.SleeveTreeResponse.fromJson(data) as T;
    }
    if (t == _i44.StalePriceAsset) {
      return _i44.StalePriceAsset.fromJson(data) as T;
    }
    if (t == _i45.SyncStatus) {
      return _i45.SyncStatus.fromJson(data) as T;
    }
    if (t == _i46.TickerMetadata) {
      return _i46.TickerMetadata.fromJson(data) as T;
    }
    if (t == _i47.YahooSymbol) {
      return _i47.YahooSymbol.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i43.SleeveTreeResponse?>()) {
      return (data != null ? _i43.SleeveTreeResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i44.StalePriceAsset?>()) {
      return (data != null ? _i44.StalePriceAsset.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i45.SyncStatus?>()) {
      return (data != null ? _i45.SyncStatus.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i46.TickerMetadata?>()) {
      return (data != null ? _i46.TickerMetadata.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i47.YahooSymbol?>()) {
      return (data != null ? _i47.YahooSymbol.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i44.StalePriceAsset>) {
      return (data as List)
              .map((e) => deserialize<_i44.StalePriceAsset>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i48.Portfolio>) {
      return (data as List).map((e) => deserialize<_i48.Portfolio>(e)).toList()
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i43.SleeveTreeResponse => 'SleeveTreeResponse',
      _i44.StalePriceAsset => 'StalePriceAsset',
      _i45.SyncStatus => 'SyncStatus',
      _i46.TickerMetadata => 'TickerMetadata',
      _i47.YahooSymbol => 'YahooSymbol',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i42.SleeveNode():
        return 'SleeveNode';
      case _i43.SleeveTreeResponse():
        return 'SleeveTreeResponse';
      case _i44.StalePriceAsset():
        return 'StalePriceAsset';
      case _i45.SyncStatus():
        return 'SyncStatus';
      case _i46.TickerMetadata():
        return 'TickerMetadata';
      case _i47.YahooSymbol():
        return 'YahooSymbol';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'SleeveTreeResponse') {
      return deserialize<_i43.SleeveTreeResponse>(data['data']);
    }
    if (dataClassName == 'StalePriceAsset') {
      return deserialize<_i44.StalePriceAsset>(data['data']);
    }
    if (dataClassName == 'SyncStatus') {
      return deserialize<_i45.SyncStatus>(data['data']);
    }
    if (dataClassName == 'TickerMetadata') {
      return deserialize<_i46.TickerMetadata>(data['data']);
    }
    if (dataClassName == 'YahooSymbol') {
      return deserialize<_i47.YahooSymbol>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i25.IntradayPrice:
        return _i25.IntradayPrice.t;
      case _i31.Order:
        return _i31.Order.t;
      case _i33.Portfolio:
        return _i33.Portfolio.t;
      case _i34.PortfolioRule:
        return _i34.PortfolioRule.t;
      case _i36.PriceCache:
        return _i36.PriceCache.t;
      case _i39.Sleeve:
        return _i39.Sleeve.t;
      case _i41.SleeveAsset:
        return _i41.SleeveAsset.t;
      case _i46.TickerMetadata:
        return _i46.TickerMetadata.t;
      case _i47.YahooSymbol:
        return _i47.YahooSymbol.t;
    }
    return null;
  }
